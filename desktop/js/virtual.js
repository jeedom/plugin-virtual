...
function addCmdToTable(_cmd) {
  ...
  if (init(_cmd.type) == 'info') {
    ...
    tr += '</span>';
    tr += '<span class="cmdAttr input-group-addon roundedRight icon_orange" data-l1key="display" data-l2key="icon" style="font-size:19px;padding:0 5px 0 0!important;"></span>';
    tr += '</div>';
    tr += '</td>';
    tr += '<td>';
    ...
    tr += '<input class="cmdAttr form-control input-sm" data-l1key="unite" placeholder="Unité" title="{{Unité}}" style="width:30%;max-width:80px;display:inline-block;">';
    tr += '</span>';
    tr += '</td>';
    tr += '<td>';
