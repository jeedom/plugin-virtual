	...
	<div class="col-xs-12 eqLogic" style="display: none;">
		<div class="input-group pull-right" style="display:inline-flex">
			<span class="input-group-btn">
                ...
                <a class="btn btn-default btn-sm" id="bt_importTemplate"><i class="fas fa-cubes"></i> {{Template}}</a>
                <a class="btn btn-default btn-sm" id="bt_importEqLogic"><i class="fas fa-share"></i> {{Importer équipement}}</a>
