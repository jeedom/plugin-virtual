...
Les fonctions utiles pour les calculs sont disponible dans la ../../../../doc/fr_FR/scenario.html#_condition_ou_valeur_d_une_commande_d_action[la documentation des scenarios].
