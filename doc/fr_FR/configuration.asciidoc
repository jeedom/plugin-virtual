Ce plugin fonctionne comme tous les autres : en haut à droite il est possible d'ajouter un équipement, de choisir l’objet parent de l’équipement, s’il est visible et actif.
